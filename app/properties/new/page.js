    ...
    <div className="space-y-3 md:space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg md:text-xl font-semibold tracking-tight text-gray-900">Add New Property</h1>
            <p className="text-xs text-gray-500 mt-0.5">Create a new wholesale property listing</p>
          </div>
        </div>
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Save size={16} />
            <span>
          ...
          <button
            ...
            disabled={saving || imageUploadStatus.isUploading}
            className="flex items-center justify-center gap-2 bg-brand-red hover:bg-red-600 text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Eye size={16} />
            <span>
              {imageUploadStatus.isUploading
        ...
        <div className="p-4 md:p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-red focus:border-brand-red outline-none transition-all text-sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Rooms/Units</label>
                  <input
                    type="number"
          ...
          {activeTab === 'content' && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Repairs & Renovation</label>
                <TextEditor
                  ref={repairsRef}
                  id="repairs-editor"
          ...
          {activeTab === 'seo' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Social Title</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Social Description</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Social Image URL</label>
                    <input
                      type="url"
